...
namespace frano_ferreteria.Migrations
{
    ...
    [Migration("20250505183738_AddBillCustomersRelations___")]
    partial class AddBillCustomersRelations___
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("frano_ferreteria.Models.Bill", b =>
                {
                    b.HasOne("frano_ferreteria.Models.Customer", "Customer")
                        .WithMany("Bills")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("frano_ferreteria.Models.Item", "Item")
                        .WithMany("Bills")
